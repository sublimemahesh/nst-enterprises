...
<html lang="en">
    ...
    <head>
        ...
        <title>Arrange Costing Types || Dashboard || NST Enterprises</title>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header font-header">Arrange Costing Types</h1>
                        </div>
                    </div>
...
<!--                                <div class="panel-heading">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <form method="post" action="post-and-get/costing-types.php" class="form-horizontal" >
                                                <div class="clearfix m-b-20">
                                                    <div class="dd nestable-with-handle">
                                                        <ol class="dd-list">
                                                            <?php
                                                            if (count($TYPES) > 0) {
                                                                foreach ($TYPES as $key => $img) {
                                                                    ?>
                                                                    <li class="dd-item dd3-item" data-id="13">
                                                                        <div class="dd-handle dd3-handle"></div>
                                                                        <div class="dd3-content">(<?php echo $key + 1; ?>) <?php echo $img['title']; ?></div>
                                                                ...
                                                                ?> 
                                                                <b>No costing types in the database.</b> 
                                                            <?php } ?> 
                                                        </ol>
                                                    </div>
                                                    <div class="row">
