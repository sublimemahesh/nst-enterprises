                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <form id="form-consignee"  method="post" action="post-and-get/account.php">
                                                <div class="form-group">
                                                    <label class="col-md-3">Start Date</label>
                                                    <input type="text" class="form-control col-md-9" placeholder="Enter start date" name="startdate" id="startdate" autocomplete="off" value="<?php echo $ACCOUNT->start_date; ?>">
                                                </div>
                                                <div class="form-group">
