...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <form id="form-consignee"  method="post" action="post-and-get/costing-types.php">
                            ...
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            <?php
                                            foreach (CostingType::all() as $type) {
                                                ?>
                                                <tr id="row_<?php echo $type['id']; ?>">
                                                    <td style="width: 50px;"><?php echo $type['id']; ?></td>
                                                    <td><?php echo $type['title']; ?></td>
                                                    <td class="text-center" style="width: 230px"> 
                                                        <a href="edit-costing-type.php?id=<?php echo $type['id']; ?>" class="op-link btn btn-sm btn-success" title="Edit"><i class="glyphicon glyphicon-pencil"></i></a>
                                                        |
                                                        <a href="#" class="delete-costing-type btn btn-sm btn-danger" data-id="<?php echo $type['id']; ?>"  title="Delete">
        ...
        <script src="delete/js/costing-types.js" type="text/javascript"></script>
