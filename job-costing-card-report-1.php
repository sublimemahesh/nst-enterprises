        ...
        <div id="wrapper">        
            ...
            <table class="table2 table-bordered" border="1">
                ...
                foreach ($REIMBURSEMENTITEMS as $reimbursementitem) {
                    $reimbursementdetails = ReimbursementDetails::getReimbursementDetailsByReimbursementItemAndType($reimbursementitem['id'], $jobcostingcard);
                    ...
                    if ($reimbursementdetails) {
                        ...
                        <tr id="row-<?php echo $reimbursementitem['id']; ?>" type="<?php echo $reimbursementdetails['type']; ?>" rdid="<?php echo $reimbursementdetails['id']; ?>" class="">
                            ...
                            <td class="amount text-right"><?php echo number_format($reimbursementdetails['amount'],2); ?></td>
                        ...
                        ?>
                        <tr id="row-<?php echo $reimbursementitem['id']; ?>" style="display: none;">
                            <td scope="row" rid="<?php echo $reimbursementitem['id']; ?>" class="rid"><?php echo $reimbursementitem['name']; ?></td>
                            <td class="vno"></td>
                    ...
                    ?>
    <!--                    <tr id="row-<?php echo $reimbursementitem['id']; ?>" class="">
                    <td scope="row" rid="<?php echo $reimbursementitem['id']; ?>" class="rid"><?php echo $reimbursementitem['name']; ?></td>
                    <td class="vno vno-<?php echo $reimbursementitem['id']; ?>"></td>
                    <td class="amount amount-<?php echo $reimbursementitem['id']; ?> text-right"></td>
                    <td class="description description-<?php echo $reimbursementitem['id']; ?> text-right"></td>
                    <td class=""></td>
                </tr>-->
                    <?php
                }
