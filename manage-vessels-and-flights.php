...
<html lang="en">
    ...
    <head>
        ...
        <title>Manage Vessels and Flights || Dashboard || NST Enterprises</title>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header font-header">Manage Vessels and Flights</h1>
                        </div>
                    </div>
...
<!--                                <div class="panel-heading">
                                    Manage Vessels and Flights
                                </div>
                                <ul class="header-dropdown">
                                    <li class="">
                                        <a href="create-vessel-or-flight.php">
                                            ...
                                            foreach (VesselAndFlight::all() as $vesselandflight) {
                                                ...
                                                <tr id="row_<?php echo $vesselandflight['id']; ?>">
                                                    ...
                                                    <td class="text-center" style="width: 200px"> 
                                                        <a href="edit-vessel-or-flight.php?id=<?php echo $vesselandflight['id']; ?>" class="op-link btn btn-sm btn-success"><i class="glyphicon glyphicon-pencil"></i></a>
                                                        |
                                                        <a href="#" class="delete-vessel-or-flight btn btn-sm btn-danger" data-id="<?php echo $vesselandflight['id']; ?>">
                                                            <i class="glyphicon glyphicon-trash" data-type="cancel"></i>
                                                        </a>
                                                        |
                                                        <a href="arrange-vessels-and-flights.php" class="btn btn-sm btn-primary">
